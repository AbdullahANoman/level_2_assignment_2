...
const updateSingleUserFromDB = (userId, body) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield user_models_1.ModelUser.isUserExist(userId)) {
        if (yield user_models_1.ModelUser.updateOne({ userId }, body)) {
...
const getTotalPriceForSingleUserInB = (userId) => __awaiter(void 0, void 0, void 0, function* () {
    if (yield user_models_1.ModelUser.isUserExist(userId)) {
        const result = yield user_models_1.ModelUser.aggregate([
            {
                $match: { userId },
            },
            {
